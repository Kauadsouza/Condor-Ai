...
export function CondorCloudApp() {
  ...
  return <main className="cloud-shell">
    <header className="app-header"><div className="app-brand"><div className="mini-orb">C</div><div><small>CONDOR CLOUD</small><strong>MESMA MENTE</strong></div></div><div className="cloud-state"><span className="live-dot"/>{status}</div><button className="icon-button" onClick={logout} title="Sair"><LogOut size={18}/></button></header>
